...
(() => {
  ...
  // src/modules/marquee/dropdown.js
  function hasDropdownInBlock(block) {
  ...
  function enableMarqueeDropdowns(block) {
  ...
  // src/modules/marquee/dom.js
  function buildContainers(element, opts) {
  ...
  function applyItemWidths(mainBlock) {
  ...
  // src/modules/marquee/images.js
  function preloadAllImagesFirst(block, isMobileMarquee) {
  ...
  function forceImagesDisplay(block) {
  ...
  function waitForImagesRender(block, isMobileMarquee) {
    return new Promise(function(resolve) {
      const images = block.querySelectorAll("img");
      if (images.length === 0) {
        resolve();
  ...
  function forceFullRender(repeatBlock1, repeatBlock2, tempContainer) {
    return new Promise(function(resolve) {
  ...
  // src/modules/marquee/safari-animate.js
  ...
  function initSafariAnimation(element, scrollContainer, mainBlock, options) {
  ...
  // src/modules/marquee/animate.js
  ...
  function initAnimation(element, scrollContainer, mainBlock, options) {
  ...
  function initStandardAnimation(element, scrollContainer, mainBlock, options) {
  ...
  var marquee = {
    ...
    _setup(element) {
      ...
      const { mainContainer, scrollContainer, mainBlock, hasDropdowns } = buildContainers(element, { originalHTML, isVertical, useAutoHeight, height, minHeight, gap });
      const ctx = {
        element,
        mainContainer,
        scrollContainer,
      ...
      if (!isVertical) {
        setTimeout(function() {
          applyItemWidths(mainBlock);
        }, 0);
      }
      preloadAllImagesFirst(mainBlock, isMobileMarquee).then(function() {
        self._assemble(ctx);
      }).catch(function() {
        self._fallback(ctx);
      });
    ...
    _assemble(ctx) {
      ...
      if (isMobileMarquee) {
        requestAnimationFrame(function() {
          requestAnimationFrame(function() {
            self._finish(ctx, repeatBlock1, repeatBlock2, tempContainer);
          });
        });
      } else {
        Promise.all([
        ...
        requestAnimationFrame(function() {
          ...
          setTimeout(function() {
            initAnimation(element, scrollContainer, mainBlock, {
              ...
              useAutoHeight: ctx.useAutoHeight
            });
          }, initDelay);
        });
      });
